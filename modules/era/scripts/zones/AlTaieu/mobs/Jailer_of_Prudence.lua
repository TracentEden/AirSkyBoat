...
-----------------------------------
local m = Module:new('zones_altaieu_mobs_jailer_of_prudence')

m:addOverride('xi.zones.AlTaieu.mobs.Jailer_of_Prudence.onMobInitialize', function(mob)
...
m:addOverride('xi.zones.AlTaieu.mobs.Jailer_of_Prudence.onMobSpawn', function(mob)
...
m:addOverride('xi.zones.AlTaieu.mobs.Jailer_of_Prudence.onMobFight', function(mob, target)
    if
...
m:addOverride('xi.zones.AlTaieu.mobs.Jailer_of_Prudence.onMobDeath', function(mob, player, optParams)
...
m:addOverride('xi.zones.AlTaieu.mobs.Jailer_of_Prudence.onMobDespawn', function(mob)
    local firstPrudence  = GetMobByID(ID.mob.JAILER_OF_PRUDENCE)
    local secondPrudence = GetMobByID(ID.mob.JAILER_OF_PRUDENCE + 1)
