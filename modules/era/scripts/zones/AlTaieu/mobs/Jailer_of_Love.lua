...
-----------------------------------
local m = Module:new('zones_altaieu_mobs_jailer_of_love')
...
m:addOverride('xi.zones.AlTaieu.mobs.Jailer_of_Love.onMobSpawn', function(mob)
...
m:addOverride('xi.zones.AlTaieu.mobs.Jailer_of_Love.onMobEngage', function(mob, target)
    mob:hideName(false)
...
m:addOverride('xi.zones.AlTaieu.mobs.Jailer_of_Love.onMobFight', function(mob, target)
    mob:setAnimationSub(2)
...
m:addOverride('xi.zones.AlTaieu.mobs.Jailer_of_Love.onMobWeaponSkill', function(target, mob, skill)
